...
3. The pull request should work for Python 3.6, 3.7, 3.8 and 3.9. Check https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug }}/tree/main/.github/workflows and make sure that the tests pass for all supported Python versions.
